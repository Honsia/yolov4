...
python train.py --data voc.data --cfg yolov4-tiny-convspp.cfg --weights '' --name yolov4-tiny-convspp --img 640 640 640 

python train.py --data voc.data --cfg yolov4-tiny.cfg --weights '' --name yolov4-tiny --img 416 416 416
```
...
python test_half.py --data voc.data --cfg yolov4-tiny.cfg --weights weights/yolov4-tiny.weights --img 416 --iou-thr 0.5 --batch-size 8

python test_half.py --data voc.data --cfg yolov4-tiny.cfg --weights weights/best_yolov4-tiny_voc.pt --img 416 --iou-thr 0.5 --batch-size 8
```
